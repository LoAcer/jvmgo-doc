...
- 第3章 解析class文件 
    ...
    - 3.3 解析常量池 
       ...
       - 3.3.11 CONSTANT_Fieldref_info、CONSTANT_Methodref_info 和CONSTANT_InterfaceMethodref_info 
       - 3.3.12 常量池小结 
    - 3.4 解析属性表 
...
- 第7章 方法调用和返回 
   ...
   - 7.4 返回指令 
   - 7.5 方法调用指令 
       - 7.5.1 invokestatic指令7.5.2 invokespecial指令 
...
- 第10章 异常处理 
   ...
   - 10.2 异常抛出 
   - 10.3 异常处理表 
   - 10.4 实现athrow指令10.5 Java虚拟机栈信息 
   - 10.6 测试本章代码 
   - 10.7 本章小结 
- 第11章 结束 
